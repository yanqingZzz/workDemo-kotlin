...
class HomeItemHolder(itemView: View) : AbsViewHolder(itemView) {
    ...
    public val mCategoryView by lazy { itemView.findViewById<TextView>(R.id.list_item_category) }
    public val mDetailView by lazy { itemView.findViewById<TextView>(R.id.list_item_detail) }
}